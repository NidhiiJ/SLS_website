  ...
  <body>
    <div id="course-detail-wrapper">
      ...
      >
        ...
        <li><a href="/SLS_website">Home</a></li>
        <li><a href="/SLS_website/about">About Us</a></li>
        <li><a href="/SLS_website/courses">Courses</a></li>
        <li><a href="/SLS_website/blogs">Blogs</a></li>
        <li>
      ...
      <div
        class="flex flex-col lg:flex-row gap-12 mx-5 sm:mx-14 lg:mx-[7.5rem] pt-2 sm:pt-10"
      >
      ...
      <!-- map -->
      <div
        class="mx-5 sm:mx-14 lg:mx-[7.5rem] mt-14 sm:mt-12 lg:mt-20 h-full rounded-2xl overflow-clip"
      >
        <iframe
