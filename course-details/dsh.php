...
<html lang="en">
  ...
  <body>
    <div id="course-detail-wrapper">
      ...
      <div
        class="flex flex-col lg:flex-row gap-10 lg:gap-12 mx-5 sm:mx-14 lg:mx-[7.5rem] pt-2 sm:pt-10"
      >
            ...
            <div class="flex flex-col gap-4">
              ...
              <div class="flex gap-8 items-center">
                ...
                <span class="generalsans font-medium"
                  >Proficiency level: C1</span
                >
              </div>
            </div>
            <button
              class="w-max custom-yellow-btn custom-btn-animation"
