          ...
          <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li aria-current="page">
              <div class="flex items-center">
                /
                <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Intercultural
                  Training</span>
              </div>
            </li>
          </ol>
      ...
      <div class="flex flex-col gap-8 lg:w-[50vw] min-w-96">
        ...
        <div class="flex flex-col gap-8">
          <p class="text-[var(--gray-600)] text-base">
            Apart from the training and other services that we provide, SLS also gives a lot of emphasis on
            the cultural sensitization of the clients by conducting high-end workshops.
            They enable our clients to understand German culture, its traditions, rituals, customs and laws.
            We have developed 12 modules which will make it easier to immerse yourself with the German
            Society. It facilitates integration into German society, fostering understanding across diverse
          ...
          <div class="flex flex-col gap-4">
            ...
            <!-- <div class="flex gap-8 items-center">
                ...
                <span class="generalsans font-medium"
