  ...
  <div id="courses-wrapper">
          ...
          <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li aria-current="page">
              <div class="flex items-center">
                /
                <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Courses</span>
              </div>
            </li>
          </ol>
        </nav>
      </div>
      <h2 class="text-2xl sm:text-[46px] lg:text-[56px] shrink-0 clashdisplay font-medium my-3">
        Courses
      </h2>
    ...
    <div id="courses-list"
      ...
      <div class="courses-card">
        ...
        <div class="courses-card-box">
          <div class="flex flex-col gap-2 items-start py-6">
            <span class="clashdisplay font-medium text-[var(--brand-blue)] text-xl sm:text-2xl">DSH Examination</span>
      ...
      <!-- Telc Examination -->
      <div class="courses-card">
        <img src="../assets/images/course-svg/telc-exam.svg" alt="" class="mx-auto w-[60%]" />
        <div class="courses-card-box">
          <div class="flex flex-col gap-2 items-start py-6">
            <span class="clashdisplay font-medium text-[var(--brand-blue)] text-xl sm:text-2xl">Telc Examination</span>
      ...
      <div class="courses-card">
        <img src="../assets/images/course-svg/ab-initio.svg" alt="" class="mx-auto w-[60%]" />
        <div class="courses-card-box">
          <div class="flex flex-col gap-2 items-start py-6">
            <span class="clashdisplay font-medium text-[var(--brand-blue)] text-xl sm:text-2xl">Ab Initio, SL and HL
              German Examination of IB</span>
      ...
      <div class="courses-card">
        <img src="../assets/images/course-svg/zuwanderer.svg" alt="" class="mx-auto w-[60%]" />
        <div class="courses-card-box">
          <div class="flex flex-col gap-2 items-start py-6">
            <span class="clashdisplay font-medium text-[var(--brand-blue)] text-xl sm:text-2xl">Deutsch-Test für
              Zuwanderer (DTZ)</span>
    ...
    <div class="admission-consultancy-wrapper h-full p-[1px] mt-40">
      <div class="admission-consultancy px-5 sm:px-14 lg:px-[7.5rem] py-20">
        <div class="flex flex-col items-center pb-24">
          <span class="generalsans font-semibold text-[var(--brand-blue)]">CONSULTATION</span>
          <h2
        ...
        <div class="flex flex-col items-center gap-6 sm:gap-8 lg:gap-40">
          <div
            ...
            <img src="../assets/images/consultancy-step-arrow.svg"
              class="hidden lg:block absolute scale-x-125 scale-y-110 top-[80%]" alt="" />
