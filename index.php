...
<body>
  <div id="main-wrapper">
    ...
    <div id="hero-section"
      ...
      <div class="absolute w-screen h-full bg-gradient-to-l from-transparent from-[42%] to-[#114f9fa2] -z-10"></div>
      <img src="../assets/images/wave-illustration.svg" alt=""
        class="invisible md:visible absolute right-0 top-[20%]" />

      <div class="mx-9 sm:mx-14 lg:mx-[7.5rem] w-full min-h-screen flex items-center py-28 sm:pt-32 sm:pb-8">
        <div class="relative">
          <div class="absolute -top-28 left-1 sm:-right-10 sm:left-auto sm:top-auto flex flex-col gap-4">
            <button class="home-hero-translate-btn">
              <img src="../assets/images/translate.svg" alt="" />
            </button>
            <img src="../assets/images/arrow-vector.svg" alt=""
              class="w-12 -scale-x-100 rotate-[55deg] translate-y-3 sm:scale-x-100 sm:rotate-0 sm:translate-y-0" />
          </div>
          <h1 class="text-[40px] sm:text-5xl md:text-[56px] clashdisplay flex flex-col gap-2 home-hero-heading"
          ...
          <button class="custom-yellow-btn mt-8 custom-btn-animation" data-text="Read More">
            Read More
          </button>
        </div>
      </div>
    ...
    <div id="aboutus-wrapper" class="relative w-full h-fit">
      <div class="hidden lg:block gradient-circle-yellow absolute top-[80%] left-[-40%] z-[-10]"></div>
      <div id="aboutus-section"
        class="flex flex-col sm:flex-row justify-between gap-4 sm:gap-10 px-5 sm:px-14 md:px-[7.5rem] pt-12 sm:pt-40">
        <h2 class="text-[32px] sm:text-[40px] md:text-[46px] lg:text-[56px] shrink-0 clashdisplay font-medium">
          About Us
        </h2>
        <span class="text-justify sm:max-w-[60%] text-sm lg:text-lg">Sprachenatelier Language Studio has been training
          students who
    ...
    <div id="withusyoucan-wrapper" class="relative w-full h-fit">
      <div class="hidden lg:block gradient-circle-yellow w-full absolute top-[46%] right-[-40%] z-[-10]"></div>
      <div id="withusyoucan-section" class="mx-5 sm:mx-14 lg:mx-[7.5rem] mt-20 sm:mt-40">
        <div class="mb-20">
          <h2 class="text-[32px] md:text-[46px] text-center lg:text-[56px] shrink-0 clashdisplay font-medium">
            With Us, You Can
          </h2>
        </div>
        <div class="flex flex-col gap-16 sm:gap-20">
          <div id="wuyc-1" class="flex flex-col-reverse sm:flex-row gap-8 sm:gap-20 justify-between items-center">
            <div>
              <h3 class="clashdisplay font-medium text-2xl sm:text-3xl lg:text-[42px] text-[#053F92] mb-3">
                Dive into German
              </h3>
          ...
          <div id="wuyc-3" class="flex flex-col-reverse sm:flex-row gap-8 sm:gap-20 justify-between items-center">
            <div>
              <h3 class="clashdisplay font-medium text-2xl sm:text-3xl lg:text-[42px] text-[#053F92] mb-3">
    ...
    <div id="metrics-wrapper" class="relative overflow-x-clip">
      <div class="hidden lg:block gradient-circle-yellow absolute top-[-20%] left-[-40%] z-[-10]"></div>
      <div class="hidden lg:block gradient-circle-yellow absolute top-[60%] right-[-40%] z-[-10]"></div>
      <div id="metrics-section"
        ...
        <div class="flex flex-col gap-6 h-full">
          ...
          <div class="flex sm:hidden flex-col metric-box h-full">
            ...
            <span class="metric-heading">Public Universities Admitted To</span>
          </div>

          <div class="flex flex-col metric-box h-full">
            <span class="metric-heading">Help When You Need It</span>
            <span class="metric-description">Need help? We’re here 24/7. Out team is super friendly and
              ready to help you with anything.</span>
            <img src="../assets/images/help-icons.svg" class="w-[90%] md:w-[72%] mx-auto" alt="" />
          </div>
        </div>
    ...
    <div id="courses-section" class="mx-5 sm:mx-14 lg:mx-[7.5rem] mt-28 sm:mt-40">
      <div class="flex flex-col items-center mb-24">
        <span class="generalsans text-sm md:text-base font-semibold text-[var(--brand-blue)]">COURSES</span>
        <h2
      ...
      <div
        ...
        <div class="courses-card">
          ...
          <div class="courses-card-box">
            <div class="flex flex-col gap-2 items-start py-6">
              <span class="clashdisplay font-medium text-[var(--brand-blue)] text-xl sm:text-[24px]">TestDaF
                Examination</span>
        ...
        <div class="courses-card">
          <img src="../assets/images/course-svg/dsh-exam.svg" alt="" class="mx-auto w-[80%]" />
          <div class="courses-card-box">
            <div class="flex flex-col gap-2 items-start py-6">
              <span class="clashdisplay font-medium text-[var(--brand-blue)] text-xl sm:text-[24px]">DSH
                Examination</span>
              <span class="text-sm sm:text-base">A language proficiency test, available only in Germany for
        ...
        <div class="courses-card">
          <img src="../assets/images/course-svg/telc-exam.svg" alt="" class="mx-auto w-[80%]" />
          <div class="courses-card-box">
            <div class="flex flex-col gap-2 items-start py-6">
              <span class="clashdisplay font-medium text-[var(--brand-blue)] text-xl sm:text-[24px]">Telc
                Examination</span>
              <span class="text-sm sm:text-base">Telc is a language exam required to study in Austria. It is
        ...
        <div class="courses-card">
          <img src="../assets/images/course-svg/ab-initio.svg" alt="" class="mx-auto w-[80%]" />
          <div class="courses-card-box">
            <div class="flex flex-col gap-2 items-start py-6">
              <span class="clashdisplay font-medium text-[var(--brand-blue)] text-xl sm:text-[24px]">Ab Initio, SL and
                HL German Examination of IB</span>
              <span class="text-sm sm:text-base">These exams are designed for the International Boards like IB
        ...
        <div class="courses-card">
          <img src="../assets/images/course-svg/zuwanderer.svg" alt="" class="mx-auto w-[80%]" />
          <div class="courses-card-box">
            <div class="flex flex-col gap-2 items-start py-6">
              <span class="clashdisplay font-medium text-[var(--brand-blue)] text-xl sm:text-[24px]">Deutsch-Test für
                Zuwanderer (DTZ)</span>
              <span class="text-sm sm:text-base">Professionals who wish to reside in Germany are supposed to
        ...
        <div class="courses-card">
          ...
          <div class="courses-card-box">
            <div class="flex flex-col gap-2 items-start py-6">
              <span class="clashdisplay font-medium text-[var(--brand-blue)] text-xl sm:text-[24px]">Intercultural
                Communication Training</span>
              <span class="text-sm sm:text-base">SLS puts emphasis on the cultural sensitization of the
    ...
    <div id="testimonials-section" class="relative h-max w-screen mt-16 sm:mt-40">
      <img src="../assets/images/wave-illustration-orange.svg" alt=""
      ...
      <div class="flex flex-col items-center mb-16 lg:mb-24">
        <span class="generalsans font-semibold text-[var(--brand-blue)] mb-2">TESTIMONIALS</span>
        <h2
      ...
      <div class="max-w-2xl mx-auto px-5 sm:px-9">
        <div class="glide">
          <div class="relative">
            <div class="glide__track testimonial-slide rounded-[20px]" data-glide-el="track">
              <ul id="testimonial-container" class="glide__slides">
              </ul>
            </div>
            <img src="../assets/images/double-quotes-open.svg" alt="" class="absolute -top-3 left-6 sm:-left-4" />
            <img src="../assets/images/double-quotes-close.svg" alt=""
    ...
    <div id="videos-section"
      ...
      <!-- First video -->
      <div class="w-full relative flex-1 border-8 border-white rounded-xl overflow-hidden">
        <iframe class="w-full" height="360" src="https://www.youtube.com/embed/z3vHcj_QE_g?si=pSrBlP760SDlorN2""
      ...
      <!--Second video -->
      <div class="w-full relative flex-1 border-8 border-white rounded-xl overflow-hidden">
        <iframe class="w-full " height="360" src="https://www.youtube.com/embed/_w-Skbvywq8?si=ZmW6ERMYrNp2JUl0"
          title="YouTube video player" frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
          referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
      </div>
    ...
    <div id="blogs-section" class="mx-5 sm:mx-14 lg:mx-[7.5rem] mt-40">
      <div class="flex flex-col items-center mb-8 sm:mb-14 lg:mb-24">
        <span class="generalsans font-semibold text-[var(--brand-blue)]">LATEST BLOGS</span>
        <h2
          ...
          <div class="blog-details-wrapper">
            <div class="Blog-details-container">
              ...
              <div class="blog-details">
                ...
                <span class="blog-description">Lorem ipsum dolor sit amet consectetur. Platea senectus
          ...
          <div class="blog-details-wrapper">
            <div class="Blog-details-container">
              ...
              <div class="blog-details">
                ...
                <span class="blog-description">Germany is not only a powerhouse of innovation and culture but also a
                  land
